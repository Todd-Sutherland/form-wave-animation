...
labels.forEach((label) => {
  label.innerHTML = label.innerText // 1. Taking the label.innerHTML for each label in the lables array, and setting it to label.innerText (EMAIL)
    ...
    ) // 3. We can use map to manipluate the array of letters, and turn it into something else/a new array in this case. This array we are creating is an array of letters with a span wrapped around each letter with a transition delay
